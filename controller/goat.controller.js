...
var Goat = /*#__PURE__*/function () {
  function Goat(url, data, method) {
    _classCallCheck(this, Goat);
    this.url = url;
    this.data = data;
    this.method = method;
  }
  return _createClass(Goat, [{
    key: "consulta",
    value: function () {
...
var ValidacionesCampos = /*#__PURE__*/function (_Interfaz) {
  function ValidacionesCampos() {
    ...
    _defineProperty(_this, "caracter_numeros", function (input) {
    ...
    _defineProperty(_this, "limitar_valor", function (input, inicio, fin, msj) {
    ...
    _defineProperty(_this, "longitud_campo", function (input, inicio, fin, msj) {
    ...
    _defineProperty(_this, "longitud_campo_exacta", function (input, longitud, msj) {
      var campo = document.getElementsByName("".concat(input))[0].value;
  ...
  return _createClass(ValidacionesCampos, [{
    key: "validar_campo",
